 ...
 *
 * <p>This enum centralizes all API endpoint URLs, ensuring that the client code does not need to be
 * aware of the specific paths for authentication or transactions.
 */
