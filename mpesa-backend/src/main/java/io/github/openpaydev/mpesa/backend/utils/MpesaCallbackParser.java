package io.github.openpaydev.mpesa.backend.utils;
 ...
 * <p>
 * The M-Pesa API communicates the result of an STK Push transaction by sending an HTTP POST request
 * to a callback URL that you provide. The body of this request contains a JSON object with the
 * transaction details. This class provides a simple, static method to parse that JSON.
 * <p>
...
public final class MpesaCallbackParser {
     ...
     *
     * @param jsonCallbackData The raw JSON string received from the M-Pesa API in the callback request body.
     * @return A deserialized {@link StkCallback} object containing the transaction results.
     * @throws JsonProcessingException if the provided JSON string is malformed or cannot be parsed into the target object.
     */
